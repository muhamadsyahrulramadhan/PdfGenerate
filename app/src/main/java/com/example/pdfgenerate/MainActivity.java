...
public class MainActivity extends AppCompatActivity {
    ...
    private void createPdfWrapper() throws FileNotFoundException,DocumentException{
        ...
        if (hasWriteStoragePermission != PackageManager.PERMISSION_GRANTED) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if
                (!shouldShowRequestPermissionRationale(Manifest.permission.WRITE_CONTACTS)) { showMessageOKCancel("You need to allow access to Storage",
    ...
    private void createPdf() throws FileNotFoundException, DocumentException {
        ...
        document.close(); previewPdf();

    }

    private void previewPdf() {
        PackageManager packageManager = getPackageManager(); Intent testIntent = new Intent(Intent.ACTION_VIEW);
